...
package org.apache.cordova.radiocoin.wallet;
...
import org.apache.cordova.radiocoin.wallet.ui.RequestCoinsActivity;
import org.apache.cordova.radiocoin.wallet.ui.SendCoinsQrActivity;
import org.apache.cordova.radiocoin.wallet.ui.WalletActivity;
import org.apache.cordova.radiocoin.wallet.ui.send.SendCoinsActivity;
import org.apache.cordova.radiocoin.wallet.util.GenericUtils;
import org.apache.cordova.radiocoin.wallet.util.MonetarySpannable;
    ...
    private static void updateWidget(final Context context, final AppWidgetManager appWidgetManager,
        ...
        if (exchangeRate != null) {
            ...
            localBalanceStr = new MonetarySpannable(localFormat, localBalance).applyMarkup(prefixSpans,
                    MonetarySpannable.STANDARD_INSIGNIFICANT_SPANS);
            if (!Constants.NETWORK_PARAMETERS.getId().equals(AbstractDogecoinParams.ID_MAINNET))
