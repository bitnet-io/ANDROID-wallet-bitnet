...
public abstract class InputParser {
    ...
    public abstract static class StringInputParser extends InputParser {
        ...
        public void parse() {
            ...
            } else if (input.startsWith("radiocoin:") || input.startsWith("RADIOCOIN:")) {
                try {
                    final BitcoinURI bitcoinUri = new BitcoinURI(Constants.NETWORK_PARAMETERS, "" + input.substring(8));
                    ...
                    log.info("got invalid radiocoin uri: '" + input + "'", x);
