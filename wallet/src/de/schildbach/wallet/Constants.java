...
public final class Constants {
    ...
    public final static class Files {
        private static final String FILENAME_NETWORK_SUFFIX = NETWORK_PARAMETERS.getId()
                .equals(AbstractDogecoinParams.ID_MAINNET) ? "" : "-testnet";
        ...
        public static final String EXTERNAL_WALLET_BACKUP = "bitnet-wallet-backup" + FILENAME_NETWORK_SUFFIX;
        ...
        public static final String CHECKPOINTS_ASSET = "";
    ...
    public static final String MIMETYPE_WALLET_BACKUP = "application/x-bitnet-wallet-backup";

    /** Number of confirmations until a transaction is fully confirmed. */
    public static final int MAX_NUM_CONFIRMATIONS = 7;

    /** User-agent to use for network access. */
    public static final String USER_AGENT = "Bitnet Wallet";
    ...
    public static final char CHAR_BITCOIN = '\u1E04';
